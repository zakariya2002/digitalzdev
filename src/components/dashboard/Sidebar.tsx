      ...
      <aside className={`fixed left-0 top-0 h-screen w-64 bg-gray-900 border-r border-gray-800 flex flex-col z-50 transition-transform duration-300 ${open ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}>
        ...
        <div className="px-6 py-5 border-b border-gray-800 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">Agence web</p>
          </div>
                ...
                {section.items.map((item) => (
                  ...
                  >
                    ...
                    {item.badge === 'messages' && totalUnread > 0 && (
                      <span className="px-1.5 min-w-5 h-5 flex items-center justify-center bg-blue-600 text-white text-[10px] font-bold rounded-full">
