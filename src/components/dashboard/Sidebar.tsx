...
const navItems = [
  ...
  { to: '/dashboard/kanban', label: 'Kanban', icon: KanbanIcon, end: false },
  { to: '/dashboard/calendar', label: 'Calendrier', icon: CalendarIcon, end: false },
  { to: '/dashboard/clients', label: 'Leads & Clients', icon: ClientsIcon, end: false },
  { to: '/dashboard/sms-templates', label: 'Templates SMS', icon: SmsIcon, end: false },
  { to: '/dashboard/revenues', label: 'Revenus', icon: RevenuesIcon, end: false },
]
